...
export type ArchitectureActivity = "transfer" | "compute" | "scan" | "read" | "write" | "generate";

export type ArchitectureFlowStep = Readonly<{
  /** Explicit operation metadata; animation never guesses from localized copy. */
    ...
    flows: [
      {
        ...
        steps: [
          { from: "client", to: "core", activity: "transfer", title: ["提出研究问题", "Ask a research question"],
          ...
          { from: "core", to: "queue", activity: "transfer", title: ["创建 Agent 任务", "Queue the Agent run"],
          ...
          { from: "queue", to: "workers", activity: "compute", title: ["唤起 LangGraph", "Start LangGraph"],
          ...
          { from: "workers", to: "models", activity: "generate", title: ["规划工具调用", "Plan tool calls"],
          ...
          { from: "models", to: "workers", activity: "compute", title: ["选择场景工具", "Choose a scene tool"],
          ...
          { from: "workers", to: "core", activity: "compute", title: ["请求授权数据", "Request authorized data"],
          ...
          { from: "core", to: "database", activity: "read", title: ["读取业务证据", "Read business evidence"],
          ...
          { from: "database", to: "core", activity: "transfer", title: ["返回数据片段", "Return data records"],
          ...
          { from: "core", to: "workers", activity: "transfer", title: ["交付场景数据", "Deliver scene data"],
          ...
          { from: "workers", to: "workers", activity: "compute", title: ["计算场景信号", "Compute scene signals"],
          ...
          { from: "workers", to: "core", activity: "read", title: ["检索相关知识", "Retrieve relevant knowledge"],
          ...
          { from: "core", to: "workers", activity: "transfer", title: ["返回精简证据", "Return compact evidence"],
          ...
          { from: "workers", to: "models", activity: "generate", title: ["生成最终答案", "Generate the final answer"],
          ...
          { from: "models", to: "workers", activity: "transfer", title: ["接收答案流", "Receive the answer stream"],
          ...
          { from: "workers", to: "core", activity: "transfer", title: ["回传增量与结果", "Send deltas and result"],
          ...
          { from: "core", to: "client", activity: "transfer", title: ["展示完整回答", "Display the complete answer"],
      ...
      },
      {
        ...
        steps: [
          { from: "client", to: "core", activity: "transfer", title: ["提交知识文本", "Submit knowledge text"],
          ...
          { from: "core", to: "storage", activity: "write", title: ["保存确认版本", "Save the approved version"],
          ...
          { from: "core", to: "queue", activity: "transfer", title: ["投递规则标签任务", "Queue rule tagging"],
            description: ["Java 发布规则标签阶段消息，携带确认产物的位置。", "Java publishes the rule-tagging stage message with the approved artifact reference."] },
          { from: "queue", to: "workers", activity: "read", title: ["读取待处理段落", "Load approved paragraphs"],
          ...
          { from: "workers", to: "workers", activity: "compute", title: ["检查规则标签", "Check rule tags"],
          ...
          { from: "workers", to: "models", activity: "generate", title: ["按需补充标签", "Request optional tagging"],
          ...
          { from: "models", to: "workers", activity: "transfer", title: ["返回候选标签", "Return proposed tags"],
            description: ["模型标签返回 Python，尚不能直接作为最终检索元数据。", "Model tags return to Python. They are not yet final retrieval metadata."] },
          { from: "workers", to: "workers", activity: "compute", title: ["回正最终标签", "Correct the final tags"],
          ...
          { from: "workers", to: "storage", activity: "write", title: ["保留阶段产物", "Preserve stage artifacts"],
          ...
          { from: "workers", to: "workers", activity: "compute", title: ["计算知识向量", "Compute knowledge vectors"],
            description: ["Python 读取确认产物，对有效 Chunk 执行 Embedding，准备待写入的知识向量。", "Python reads the approved artifact and embeds valid chunks, preparing knowledge vectors for indexing."] },
          { from: "workers", to: "database", activity: "write", title: ["写入知识索引", "Write the knowledge index"],
            description: ["计算完成的向量传入 PostgreSQL，按任务重建 knowledge_vector；本例存在可写入的有效 Chunk。", "Computed vectors reach PostgreSQL and rebuild knowledge_vector for the task. This example contains valid content to index."] },
          { from: "client", to: "core", activity: "transfer", title: ["查看入库结果", "Check ingestion results"],
            description: ["用户回到知识库查看结果，查询仍通过 Java 接口。", "The user opens the knowledge library to check results through the Java API."] },
          { from: "core", to: "database", activity: "read", title: ["查询知识记录", "Query knowledge records"],
          ...
          { from: "database", to: "core", activity: "transfer", title: ["返回索引结果", "Return indexed records"],
            description: ["带来源与标签的知识记录返回业务服务。", "Knowledge records with provenance and tags return to the application service."] },
          { from: "core", to: "client", activity: "transfer", title: ["知识可以检索", "Knowledge is searchable"],
      ...
      },
      {
        ...
        documents: ["docs/OCR_PIPELINE.md", "docs/chunk入库打标签文档.md"],
        steps: [
          { from: "client", to: "core", activity: "transfer", title: ["上传研究图片", "Upload a research image"],
          ...
          { from: "core", to: "storage", activity: "write", title: ["保存原始文件", "Preserve the source file"],
            description: ["Java 校验文件并写入 MinIO，创建可追踪的 OCR 任务。", "Java validates the file, saves it in MinIO and creates a traceable OCR task."] },
          { from: "core", to: "queue", activity: "transfer", title: ["启动标准化阶段", "Queue normalization"],
          ...
          { from: "queue", to: "workers", activity: "scan", title: ["标准化页面", "Normalize the page"],
          ...
          { from: "workers", to: "models", activity: "scan", title: ["请求视觉识别", "Request visual recognition"],
            description: ["图片分支调用 Qwen-VL OCR，把页面图像转换为文字片段。", "The image branch calls Qwen-VL OCR to convert page images into text segments."] },
          { from: "models", to: "workers", activity: "transfer", title: ["接收识别片段", "Receive recognized segments"],
            description: ["识别结果回到 Python，仍需清洗与人工复核。", "Recognition results return to Python and still require cleaning and human review."] },
          { from: "workers", to: "workers", activity: "compute", title: ["清洗识别草稿", "Clean the recognized draft"],
            description: ["Python 整理 paragraphs、标记低置信度与疑似乱码，准备清洗后的草稿。", "Python prepares paragraphs and flags low confidence and suspected garbling in the cleaned draft."] },
          { from: "workers", to: "storage", activity: "write", title: ["保存清洗草稿", "Save the cleaned draft"],
            description: ["清洗后的草稿传入 MinIO，保存为 cleaned.json，供后续质量校验读取。", "The cleaned draft reaches MinIO as cleaned.json for subsequent quality validation."] },
          { from: "workers", to: "queue", activity: "transfer", title: ["通知质量校验", "Queue quality validation"],
          ...
          { from: "queue", to: "core", activity: "transfer", title: ["创建人工复核", "Create a human review"],
          ...
          { from: "core", to: "client", activity: "transfer", title: ["展示待确认文本", "Show text for approval"],
          ...
          { from: "client", to: "core", activity: "transfer", title: ["人工确认通过", "Human approves the text"],
          ...
          { from: "core", to: "storage", activity: "write", title: ["保存审核版本", "Save the reviewed version"],
          ...
          { from: "core", to: "queue", activity: "transfer", title: ["启动标签处理", "Queue chunk tagging"],
            description: ["确认后，Java 才发布规则标签阶段消息。", "Only after approval does Java publish the rule-tagging stage message."] },
          { from: "queue", to: "workers", activity: "compute", title: ["标签质量门与回正", "Tag quality gate and correction"],
          ...
          { from: "workers", to: "database", activity: "write", title: ["索引有效 Chunk", "Index valid chunks"],
          ...
          { from: "client", to: "core", activity: "transfer", title: ["查看任务结果", "Check the task result"],
          ...
          { from: "core", to: "database", activity: "read", title: ["读取完成状态", "Read completion state"],
            description: ["Java 查询当前用户的任务状态与知识记录。", "Java reads the current user’s task state and knowledge records."] },
          { from: "database", to: "core", activity: "transfer", title: ["返回完成结果", "Return completion results"],
            description: ["存储层返回已完成的任务和有效知识条目。", "The store returns the finished task and valid knowledge entries."] },
          { from: "core", to: "client", activity: "transfer", title: ["图片成为知识", "The image becomes knowledge"],
    ...
    flows: [
      {
        ...
        steps: [
          { from: "client", to: "core", activity: "transfer", title: ["请求一条路线", "Request a route"],
          ...
          { from: "core", to: "database", activity: "read", title: ["读取画像与 POI", "Read profiles and POIs"],
            description: ["Java 加载用户画像，并从空间数据中召回候选地点。", "Java loads the user profile and retrieves candidate places from spatial data."] },
          { from: "database", to: "core", activity: "transfer", title: ["返回候选地点", "Return candidate places"],
          ...
          { from: "core", to: "core", activity: "compute", title: ["筛选受控候选池", "Select a bounded POI pool"],
          ...
          { from: "core", to: "models", activity: "generate", title: ["组合路线草案", "Compose route drafts"],
          ...
          { from: "models", to: "core", activity: "transfer", title: ["返回候选顺序", "Return proposed sequences"],
          ...
          { from: "core", to: "cache", activity: "read", title: ["检查路段缓存", "Check segment cache"],
          ...
          { from: "core", to: "maps", activity: "compute", title: ["校准真实路段", "Calibrate real segments"],
            description: ["调用高德获取相邻 POI 之间的真实距离与耗时。", "Amap supplies actual distances and travel times between adjacent POIs."] },
          { from: "maps", to: "core", activity: "transfer", title: ["返回地图事实", "Return map facts"],
          ...
          { from: "core", to: "core", activity: "compute", title: ["校验路线约束", "Validate route constraints"],
          ...
          { from: "core", to: "client", activity: "transfer", title: ["展示可执行路线", "Show executable routes"],
